...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'An interactive event promotion website built for the CSE Department to showcase event details, schedules, rules, and registrations. Instead of using traditional forms or a MERN backend, we integrated Google Sheets with Node.js to store and manage registrations seamlessly. The site includes smooth animations, a responsive UI, and a clean structure for better engagement and participation.',
